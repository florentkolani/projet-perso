        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CotationAssurance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MajorationEconomat = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ProprietaireId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Engins", x => x.EnginId);
                    table.ForeignKey(
                        name: "FK_Engins_Proprietaires_ProprietaireId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Factures_Proprietaires_ProprietaireId",
                        column: x => x.ProprietaireId,
                        principalTable: "Proprietaires",
                        principalColumn: "ProprietaireId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Engins_ProprietaireId",
                table: "Engins",
                column: "ProprietaireId");

            migrationBuilder.CreateIndex(
                name: "IX_Factures_ProprietaireId",
                table: "Factures",
                column: "ProprietaireId");
